      ...
      <section className="bg-gradient-to-br from-black to-blue-900 py-5 md:py-20 md:px-[10rem] h-auto md:h-[calc(100vh-84px)] flex justify-center">
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0 ">
          <div className="flex flex-col justify-center gap-8">
            ...
            <Button size="lg" asChild className="button w-full sm:w-fit bg-blue-900">
              <Link href="#events">
                Explore Now
              </Link>
            </Button>
          ...
          <Image 
            ...
            width={1000}
            height={1000}
            className="max-h-[40vh] md:max-h-[70vh] object-contain object-center 2xl:max-h-[50vh]"
          />
        </div>
      </section> 

      <section id="events" className="flex flex-col gap-8 md:gap-12 px-6 py-10 md:px-20 bg-gradient-to-br from-black to-blue-900">
        <h2 className="h2-bold text-blue-100">Trust by <br /> Thousands of Events</h2>
