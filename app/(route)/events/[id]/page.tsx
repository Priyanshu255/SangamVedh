...
const EventDetails = async ({
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          <div className="flex justify-center items-start md:items-center">
            <Image
              ...
              width={1000}
              height={1000}
              className="h-4/5 min-h-[300px] object-cover object-center shadow-2xl rounded-lg"
            />
          </div>
      ...
      <section className="max-w-full py-8 px-[2rem] md:px-[8rem] lg:px-[14rem] flex flex-col gap-8 md:gap-12 bg-gradient-to-br from-black to-blue-900 text-blue-200">
